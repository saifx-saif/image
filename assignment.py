...
c_x = int(input("Center x: "))
c_y = int(input("Center y: "))
...
def img_choice(kernel):
    ...
    if inp=="1": 
        ...
        cv.imshow('Merged Difference', diff_merge1)
...
while inp:
    ...
    2.Mean Kernel
    3.Laplacian Kernel
    4.Laplacian of Gaussian Kernel
    ...
    if inp=="1": 
        ...
        print("\n Laplacian Kernel") 
        kernel = laplace_kernel_5()
        print(kernel)
        image = img_choice(kernel)
    elif inp=="4":
        print("\n LoG Kernel")
        kernel = laplace_kernel_log()
        print(kernel)
        image = img_choice(kernel)
    elif inp=="5":
